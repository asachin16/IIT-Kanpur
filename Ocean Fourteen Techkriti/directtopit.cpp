...
int gix=200,giy=175,gfy=265,bix=423,biy=102;
int l=43,m=70,n=25;
                         ...
                         for(j=0;j<width;j++)
                         {
                                             ...
                                             v=data[i*step+j*channels+2];
                                              //if(((h>75&&h<85)) && (s>80 && s<120) && (v>50 && v<=100)) green
                                               if(((h<=10)) && (s>130 && s<190) && (v>210 && v<=256))//violet Caliberation
                                             {
...
int yellow(IplImage* img0,int f){
    ...
    for(i=0;i<height;i++)
    {
                         ...
                         for(j=0;j<width;j++)
                         {
                                             ...
                                             else if((h>15&&h<25)&&(s>150&&s<190)&&(v>180&&v<=200))   //Yellow caliberation
                                             {
...
int blue(IplImage* img0,int f){
    ...
    for(i=0;i<height;i++)
    {
                         ...
                         for(j=0;j<width;j++)
                         {
                                             ...
                                             s=data[i*step+j*channels+1];
                                             v=data[i*step+j*channels+2];
                                              if(((h>105&&h<112)) && (s>170 && s<200) && (v>155 && v<=175))  //blue Caliberation
                                             {
...
int black(IplImage* img,int f){
    ...
    for(i=0;i<height;i++)
    {
                         ...
                         for(j=0;j<width;j++)
                         {
                                             ...
                                             s=data[i*step+j*channels+1];
                                             v=data[i*step+j*channels+2];
                                              if((h<63)&&(s<63)&&(v<=63))  //black Caliberation
                                             {
