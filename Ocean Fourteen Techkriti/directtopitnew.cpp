...
int gix=200,giy=128,gfy=265,bix=423,biy=102;
int l=25,m=70,n=25;
...
int yellow(IplImage* img0,int f){
    ...
    for(i=0;i<height;i++)
    {
                         ...
                         for(j=0;j<width;j++)
                         {
                                             ...
                                             else if((h>15&&h<25)&&(s>150&&s<190)&&(v>180&&v<=205))   //Yellow caliberation
                                             {
...
int green(IplImage* img0,int f){
    ...
    for(i=0;i<height;i++)
    {
                         ...
                         for(j=0;j<width;j++)
                         {
                                             ...
                                             if((h>65&&h<78)&&(s>140&&s<255)&&(v>130&&v<=255))   //Green caliberation
                                             {
                          ...
                          if(datablack[(pinky-l)*sb+(pinkx)*cb+0]!=0)
                          {
                                   ...
                                   else if((pinkx > bix && pinky < biy)==0)
                                   {
                                       ...
                                       printf("F\n");
                                        ...
                                        if(((datablue[(pinky-40)*sb+(pinkx-30)*cb+0]!=0)&&(bluex[20]-bluex[0]<0&&flag3==1)))
                                        {
                                                                                 com->sendChar('g');
                                                                                 printf("blueforward\n");
                                                                                 flag3=0;
                                        ...
                                        else if(datayellow[(violety-40)*sb+(violetx-30)*cb+0]!=0){
                                             com->sendChar('b');
                                             }
                                        else if(pinky < bluey){
                                             com->sendChar('s');
